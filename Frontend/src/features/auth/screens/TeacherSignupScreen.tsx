...
export const TeacherSignupScreen = ({ navigation }: any) => {
  ...
  return (
    ...
    >
      ...
      {/* Heading */}
      <Text style={styles.heading}>Create Teacher Account</Text>
...
// Reuse the same styles as TeacherLoginScreen (copy-paste them here)
