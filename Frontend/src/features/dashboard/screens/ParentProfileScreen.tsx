            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.profileCard}>
                    <Pressable style={styles.avatarWrapper} onPress={pickAvatar}>
                        {avatar ? (
                            ...
                            <Image source={require('../assets/Homescreen/parent.png')} style={styles.avatarImage} />
                        )}
                    ...
                    <Text style={styles.parentName}>{user?.name || 'Sarah Jenkins'}</Text>
                    <Text style={styles.parentEmail}>{user?.email || 'sarah.jenkins@example.com'}</Text>
                ...
                <View style={styles.sectionHeader}>
                    ...
                    <Pressable style={styles.switchProfileRow}>
                        <Icon name="swap-horizontal" size={16} color="#1B337F" />
                        <Text style={styles.switchProfileText}>Switch Profile</Text>
                    </Pressable>
                </View>

                <View style={styles.childrenRow}>
                    {students?.slice(0, 2).map((child: any) => (
                        <View key={child.id} style={styles.childBadge}>
                            <Image
                                source={child.avatar ? { uri: child.avatar } : require('../assets/Homescreen/student.png')}
                                style={styles.miniChildAvatar}
                            />
                            <View>
                                <Text style={styles.childName}>{child.name}</Text>
                                <Text style={styles.childLevel}>Level 4</Text>
                            </View>
                        </View>
                    ))}
                ...
                <Pressable style={styles.linkChildBtn} onPress={() => navigation.navigate('ParentAddChild')}>
