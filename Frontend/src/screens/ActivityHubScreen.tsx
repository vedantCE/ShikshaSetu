...
import LinearGradient from 'react-native-linear-gradient';
import  SafeAreaEaseView  from 'react-native-safe-area-context';
import Icon from 'react-native-vector-icons/MaterialCommunityIcons';
import type { NativeStackNavigationProp } from '@react-navigation/native-stack';
...
type Props = {
  navigation: NativeStackNavigationProp<RootStackParamList, 'ActivityHub'>; // Change 'ActivityHub' to your actual screen name if different
};
...
export const ActivityHubScreen = ({ navigation }: Props) => {
  ...
  return (
    <SafeAreaEaseView style={styles.container}>
      {/* Header */}
